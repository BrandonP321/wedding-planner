...
export const PrivacyPolicy = (props: PrivacyPolicyProps) => {
  return (
    <BasicPage>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to PersonaVerse, LLC, 8 The Green, Suite B,
            Dover, DE 19901.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to PersonaVerse, accessible from{" "}
            <a
              href="https://personaverse.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://personaverse.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@personaverse.com</li>
      </ul>
      <p>
